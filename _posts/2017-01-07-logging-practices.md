...
With the above in place, your application hosts become responsible for hooking up log outputs/sinks so that your logs actually go somewhere. I recommend the following as a bare minimum:
